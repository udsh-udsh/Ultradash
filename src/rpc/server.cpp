...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Ultradash server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Ultradash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ultradash features */
        {"ultradash", "listmasternodes", &listmasternodes, true, true, false},
        {"ultradash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ultradash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ultradash", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ultradash", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ultradash", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ultradash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ultradash", "masternodedebug", &masternodedebug, true, true, false},
        {"ultradash", "startmasternode", &startmasternode, true, true, false},
        {"ultradash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ultradash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ultradash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ultradash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ultradash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ultradash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ultradash", "preparebudget", &preparebudget, true, true, false},
        {"ultradash", "submitbudget", &submitbudget, true, true, false},
        {"ultradash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ultradash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ultradash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ultradash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ultradash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ultradash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ultradash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ultradash", "checkbudgets", &checkbudgets, true, true, false},
        {"ultradash", "mnsync", &mnsync, true, true, false},
        {"ultradash", "spork", &spork, true, true, false},
        {"ultradash", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> ultradash-cli " + methodname + " " + args + "\n";
}
